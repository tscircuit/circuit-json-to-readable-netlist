...
const wordQualityScore = {
  ...
  SDA: 1.2,
  SCL: 1.2,
  BRIDGE_EXCITATION: 1.2,
  LOAD_CELL_SIGNAL: 1.2,
  STRAIN_GAUGE_INPUT: 1.2,
  EXCITATION_ENABLE: 1.2,
  SENSE_REFERENCE: 1.15,
  INSTRUMENTATION_INPUT: 1.15,
  AMPLIFIER_OUTPUT: 1.15,
  BRIDGE_SENSE: 1.15,
  RX: 1.15,
  TX: 1.15,
  GPIO: 1.1,
